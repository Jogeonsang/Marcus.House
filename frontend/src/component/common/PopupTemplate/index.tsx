            ...
            {visible && (
                <S.Container>
                    ...
                    <S.Panel border={border}>
                        ...
                        {footerButton && (
                            <S.ButtonGroup>
                                <button onClick={onCancelClick} style={leftCustomButtonStyle ? leftCustomButtonStyle : customButtonStyles.left}>
                                    {onCancelButtonText}
                                </button>
                                <button onClick={onConfirmClick} style={rightCustomButtonStyle ? rightCustomButtonStyle : customButtonStyles.right}>
                                    {onConfirmButtonText}
                                </button>
                            </S.ButtonGroup>
                        )}
